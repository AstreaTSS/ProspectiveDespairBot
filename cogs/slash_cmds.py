...
class SlashCMDS(commands.Cog):
    ...
    @commands.guild_permissions(673355251583025192, role_ids=utils.ADMIN_PERMS)
    ...
    @commands.guild_permissions(673355251583025192, role_ids=utils.ALIVE_PLAYER_PERMS)
